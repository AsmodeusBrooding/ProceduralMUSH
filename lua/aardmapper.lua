...
Authors: Original by Nick Gammon. Modified for Procedural Realms by Asmodeus, and heavily modified by Fiendish for Aardwolf.
...
local credits = {
   ...
   "Made for Procedural Realms by Asmodeus",
   "Based heavily on work by Fiendish and Nick Gammon",
   "World: "..WorldName (),
   GetInfo (3),
}
